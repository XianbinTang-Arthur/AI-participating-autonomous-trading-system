...
> 当前覆盖层最后复核：2026-08-29（核对基线 `main@f9bb249964364d457cd307f8ea427a65b7320888` + 当前 FS-016 NATS exact-ownership 候选；以本文档所在最终 HEAD 为准）
