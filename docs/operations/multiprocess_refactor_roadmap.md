...
> **历史 Roadmap（2026-08-22 核对）**：本文保存 2026-04 的阶段状态和 commit 证据，不再是当前架构或部署真相。当前拓扑见根目录 `ARCHITECTURE.md`，部署只能走 `scripts/deploy.sh`。文中的手工 Compose、容器数量、待办和完成度不得用于当前操作。
