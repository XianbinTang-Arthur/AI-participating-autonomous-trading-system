...
> **历史 Release Notes（2026-08-22 核对）**：本文保存当时待发布方案和旧回滚命令，不是当前发布状态或操作指南。参数发布/回滚以 `production_parameter_change_runbook.md` 为准；文中的 `apply_active_parameter_set.py` 已禁用。
