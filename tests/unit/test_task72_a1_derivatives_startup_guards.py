...
class TestTask72A1DerivativesStartupGuards(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_disabled_non_protective_entry_execution_emits_startup_warning(self) -> None:
        ...
        self.assertIn("startup_deprecated_auto_parallel_key", rendered)
        self.assertIn("strategy_sleeve_auto_execution_enabled", rendered)
