...
CREATE TABLE IF NOT EXISTS portfolio_allocation_decisions (
	...
	expected_edge_bps NUMERIC(36, 18),
	expected_cost_bps NUMERIC(36, 18),
	created_at TIMESTAMP WITH TIME ZONE NOT NULL,
	payload JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS strategy_execution_bundles (
	...
	bundle_priority VARCHAR(32) NOT NULL,
	status VARCHAR(32) NOT NULL,
	selected_symbol VARCHAR(64) NOT NULL,
	gross_requested_exposure NUMERIC(36, 18) NOT NULL,
	net_approved_exposure NUMERIC(36, 18) NOT NULL,
	expected_cost_bps NUMERIC(36, 18),
	expected_edge_bps NUMERIC(36, 18),
	portfolio_risk_budget_state VARCHAR(32),
	created_at TIMESTAMP WITH TIME ZONE NOT NULL,
	payload JSON NOT NULL,
