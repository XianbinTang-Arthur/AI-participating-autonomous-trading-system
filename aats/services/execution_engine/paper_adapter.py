...
class PaperExecutionAdapter(ExchangeAdapter):
    ...
    @staticmethod
    def _submission_payload_from_intent(intent: OrderIntent) -> dict[str, str]:
        return {
            ...
            "closeOnly": "true" if intent.close_only else "false",
            "reduceOnlyReason": intent.reduce_only_reason or "",
            "closeOnlyReason": intent.close_only_reason or "",
            "instrumentFamily": intent.instrument_family or "",
            "settleCurrency": intent.settle_currency or "",
            "strategyFamily": intent.strategy_family or "",
            "strategySleeveId": intent.strategy_sleeve_id or "",
