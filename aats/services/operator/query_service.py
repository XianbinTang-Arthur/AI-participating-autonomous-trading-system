...
class OperatorQueryService:
    ...
    def _risk_reason_message(code: str) -> str:
        messages = {
            ...
            "risk_max_long_notional_exceeded": "多头名义敞口超过上限，系统禁止继续扩大多头仓位。",
            "risk_max_short_notional_exceeded": "空头名义敞口超过上限，系统禁止继续扩大空头仓位。",
            "risk_max_gross_notional_exceeded": "多空合计名义敞口超过上限，系统禁止继续扩大总敞口。",
            "risk_max_net_notional_exceeded": "多空相抵后的净名义敞口超过上限，系统禁止继续扩大净敞口。",
