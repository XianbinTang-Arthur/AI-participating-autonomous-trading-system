...
class ExecutionOrderModel(Base):
    ...
    position_intent: Mapped[str | None] = mapped_column(String(32), nullable=True, index=True)
    execution_style: Mapped[str | None] = mapped_column(String(32), nullable=True)
    state: Mapped[str] = mapped_column(String(32), nullable=False, index=True)
...
class ExecutionFillModelV2(Base):
    ...
    strategy_leg_role: Mapped[str | None] = mapped_column(String(32), nullable=True, index=True)
    liquidity_role: Mapped[str | None] = mapped_column(String(16), nullable=True)
    fee_rate: Mapped[str | None] = mapped_column(String(32), nullable=True)
    exec_type: Mapped[str | None] = mapped_column(String(16), nullable=True)
...
class DecisionAuditRecordModel(Base):
    ...
    allocation_id: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    decision_context_ref: Mapped[str] = mapped_column(String(128), nullable=False)
    strategy_coordinator_snapshot_ref: Mapped[str | None] = mapped_column(String(128), nullable=True)
    strategy_sleeve_intent_refs: Mapped[list] = mapped_column(JSON, nullable=False, default=list)
    portfolio_allocation_decision_ref: Mapped[str | None] = mapped_column(String(128), nullable=True)
    baseline_assessment_ref: Mapped[str | None] = mapped_column(String(128), nullable=True)
    ai_decision_brief_ref: Mapped[str | None] = mapped_column(String(128), nullable=True)
    ai_market_assessment_ref: Mapped[str | None] = mapped_column(String(128), nullable=True)
    ai_action_proposal_ref: Mapped[str | None] = mapped_column(String(128), nullable=True)
    ...
    position_target_ref: Mapped[str | None] = mapped_column(String(128), nullable=True)
    decision_outcome_ref: Mapped[str | None] = mapped_column(String(128), nullable=True)
    policy_decision_ref: Mapped[str | None] = mapped_column(String(128), nullable=True)
    risk_decision_ref: Mapped[str | None] = mapped_column(String(128), nullable=True)
    execution_plan_ref: Mapped[str | None] = mapped_column(String(128), nullable=True)
    execution_plan_refs: Mapped[list] = mapped_column(JSON, nullable=False, default=list)
    strategy_execution_bundle_ref: Mapped[str | None] = mapped_column(String(128), nullable=True)
    ...
    portfolio_delta_ref: Mapped[str | None] = mapped_column(String(128), nullable=True)
