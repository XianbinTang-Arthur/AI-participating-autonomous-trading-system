        ...
        with self.session_factory() as session:
            ...
            if row is None:
                row = StrategySleeveIntentModel(
                    ...
                    signal_bar_start=intent.signal_bar_start,
                    signal_bar_end=intent.signal_bar_end,
                    market_data_asof=intent.market_data_asof,
                    parameter_set_id=intent.parameter_set_id,
                ...
                row.timeframe = intent.timeframe
                row.signal_bar_start = intent.signal_bar_start
                row.signal_bar_end = intent.signal_bar_end
                row.market_data_asof = intent.market_data_asof
                row.parameter_set_id = intent.parameter_set_id
                row.runtime_generation = intent.runtime_generation
                row.code_version = intent.code_version
                row.market_snapshot_ref = intent.market_snapshot_ref
                row.feature_snapshot_ref = intent.feature_snapshot_ref
